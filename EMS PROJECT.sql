...
INSERT INTO Employee (EmployeeID, FirstName, LastName, DateOfBirth, Gender, PhoneNumber, Email, HireDate, 
...
-- 8. Question: Retrieve the first names of employees and the projects they are working on, along with their role 
-- in the project.
...
-- 15. Question: Retrieve the names of employees, department name, and total salary, ordered by total salary in 
-- descending order.
...
-- 17. Question: Create a function to find employees in a specified department and calculate their years of service
CREATE FUNCTION GetEmployeesByDepartment(@DepartmentName NVARCHAR(255))
RETURNS TABLE
AS
RETURN 
(
